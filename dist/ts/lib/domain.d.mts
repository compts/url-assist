 ...
 *  }
 */
declare const getDomainDetails: (domain: string) => any;
/**
 ...
 *
 */
declare const isUrlValidFormatVerifier: (domain: string, config: object | null) => any;
/**
 * Get domain details
 *
 * @since 1.1.0
 ...
 *
 */
declare const urlDetails: (domain: string) => any;
