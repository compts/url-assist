import {phpSerialize} from "../../dist/esm/index.mjs";
...
describe('TS: phpSerialize method', function () {


 
     it('return value string', function () {
 
         assert.deepStrictEqual(phpSerialize("Violet"), 's:6:"Violet";');
   ...
   it('return value for nested `dict` with array', function () {
    ...
    it('check expected type', function () {
        ...
        expectType<string>(phpSerialize(["22s"]));
